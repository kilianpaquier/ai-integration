...
Codebases might sometime be a lot of files, with various structures, interactions et architectures.
...
This fix this behavior, codebases can be indexed through graph-based databases. By doing this, an agent can use the exposed MCP server
...
my-agent plugin install codebase-memory-mcp@bunch-of
```

```sh
apm marketplace add https://gitlab.com/kilianpaquier/ai-marketplace
apm install codebase-memory-mcp@bunch-of
```
{{< /tab >}}
...
```sh
my-agent plugin marketplace add https://gitlab.com/kilianpaquier/ai-marketplace
my-agent plugin install codegraph@bunch-of
```

```sh
apm marketplace add https://gitlab.com/kilianpaquier/ai-marketplace
apm install codegraph@bunch-of
```
{{< /tab >}}
