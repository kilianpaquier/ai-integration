...
Complete the [caveman](../cave-talk) stack.
...
my-agent plugin install cavemem@bunch-of
```
{{< /tab >}}

{{< tab name="Mempalace" >}}
A [MCP server](https://github.com/MemPalace/mempalace) capable of segmenting memories.
By far the most advanced memory-based tool,
it offers multiple features around its memory palace (e.g. wings, diaries, old sessions indexing, projects mining).
